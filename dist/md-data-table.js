  ...
  function mdEditDialog($compile, $controller, $document, $mdUtil, $q, $rootScope, $templateCache, $templateRequest, $window) {
    ...
    function getTemplate(options) {
      return $q(function (resolve, reject) {
        ...
        if (template) {
          return angular.isString(template) ? resolve(template) : illegalType(_typeof(template));
        }
    ...
    function postLink(scope, element, attrs, ctrls) {
      ...
      if (tableCtrl.$$rowSelect && self.id) {
        if (tableCtrl.$$hash.has(self.id)) {
          var index = tableCtrl.selected.findIndex(function (m) {
            return getId(m) === self.id;
      ...
      self.deselect = function () {
        ...
        var i = self.id ? tableCtrl.selected.findIndex(function (m) {
          return getId(m) === self.id;
...
//# sourceMappingURL=md-data-table.js.map
